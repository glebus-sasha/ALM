...
## 6. Расчёт индексов альфа и бета-разнообразия в сообществах для выявления различий/сходств в составах сообществ. Построение PCoA/NMDS графиков на основании расстояний Брея-Кертиса.
```{r}
data %>% glimpse()
```
